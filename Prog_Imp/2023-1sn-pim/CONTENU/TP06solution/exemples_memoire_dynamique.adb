...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		-- La valeur affichée est 0.  Ce qui pourrait laisser penser que la
		-- zone libérée est mise à 0 ou quelle est utilisée, par exemple pour
		-- conserver des informations sur les blocs de mémoire vide.
		...
		-- Réponse : valgrind signale les accès erronés à la mémoire dynamique.
		--
	...
	begin
		...
		-- Réponse : Il faut !  Sinon la mémoire des cellules qui a été allouée
		-- dynamiquement ne sera pas libérée.
		Detruire (P);

...
procedure Evaluer_Alea is
    ...
    is
        ...
        Nombre     : Integer;                     -- Nombre tiré aléatoirement
    begin
        ...
        -- Comptabiliser les résultats de « Taille » tirages aléatoires
        for I in 1..Taille loop
            Get_Random_Number (Nombre);
            -- Put (Nombre, 1); New_Line;
        ...
        Min := Frequences (1);
        Max := Min;
        --   Mettre à jour avec les autres fréquences

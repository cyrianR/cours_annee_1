pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~exemple_vecteurs_creux.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~exemple_vecteurs_creux.adb");

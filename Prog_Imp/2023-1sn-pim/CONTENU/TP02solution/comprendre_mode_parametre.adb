...
procedure Comprendre_Mode_Parametre is
    ...
    begin
        ...
        R := Double (10);
        R := Double (10 * A);
        R := Double (B);    -- devrait être erreur car B non initialisé ! -- 
        ...
        Incrementer (B);  -- devrait être erreur car B en out et non initialisé !
        ...
        Mettre_A_Zero (B);  -- Warning : Valeur donnée à B non utilisée
    ...
    begin
        ...
        L := A; -- Warning : Valeur de L non utilisée avant prochaine affectation
        -- Erreur : A en in ! -- A := 1;

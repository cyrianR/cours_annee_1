...
procedure Specifier_Et_Tester is
    ...
    begin
        Resultat := Pgcd (0, 10);
            -- L'appel précédent est incorrect car la précondition de Pgcd
            -- n'est pas satisfaite (on a pas A > 0) !
            -- C'est la responsabilité de l'appelant de s'assurer que la
            -- précondition de l'appelé est vraie (satisafaite).
        Put ("Pgcd (0, 10) = ");
        Put (Resultat, 1);
        New_Line;
    end Utiliser_Pgcd;

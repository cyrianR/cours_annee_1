...
\begin{figure}[H]
    \centering
    \includegraphics[width=9cm]{simulink_controle_pend_inv.png} % joli logo de l'N7
...
\begin{figure}[H]
    ...
    \includegraphics[width=19cm]{systeme_pend_inv.png} % joli logo de l'N7
...
\begin{figure}[H]
    \centering
    \includegraphics[width=11cm]{controle_pend_inv.png} % joli logo de l'N7
